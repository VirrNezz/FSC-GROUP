...
// --- DATA MEDIA SOSIAL (FORMAT KARTU MIRIP OUR GROUPS) ---
const socialCards = [
  {
    id: 'whatsapp',
    name: 'WhatsApp Group',
    description: 'Join our primary community group on WhatsApp to chat, share, and stay updated with daily discussions.',
...
export function Home() {
  ...
  return (
    <div className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 py-16 md:py-24 lg:py-32 flex flex-col gap-16 md:gap-24 lg:gap-32">
      ...
      {/* Social Media Section (DI BAWAH OUR GROUPS & STYLING SAMA PERSIS) */}
      <section className="w-full">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
