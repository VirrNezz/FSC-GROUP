...
export function AdminPanel() {
  ...
  // Handle Kirim Broadcast Notifikasi lewat backend endpoint kita sendiri.
  // PENTING: tidak ada API key OneSignal di sini sama sekali. Kunci rahasia
  // (ONESIGNAL_REST_API_KEY) sekarang hanya hidup di server, lihat
  // /api/broadcast-notification.js. Yang kita kirim ke server hanyalah
  // Firebase ID token milik admin yang sedang login, supaya server bisa
  // memverifikasi identitasnya sebelum mengirim broadcast.
  const handleBroadcastNotification = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Token sesi berumur pendek (auto-refresh oleh SDK Firebase), aman
      // untuk dikirim ke backend kita sendiri di setiap request.
